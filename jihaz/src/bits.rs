...
impl StashInBits for u64 {
    fn add_to_right_given_value(&mut self, value: u64, right_max_value: u64) {
        *self = stash_in_bit_const::add_to_right_given_value(*self, value, right_max_value);
    }

    fn add_to_right_given_bits(&mut self, value: u64, bits_of_right_max_value: usize) {
        *self = stash_in_bit_const::add_to_right_given_bits(*self, value, bits_of_right_max_value);
    }

    fn take_from_right_given_value(&mut self, right_max_value: u64) -> u64 {
        let (this, res) = stash_in_bit_const::take_from_right_given_value(*self, right_max_value);
        *self = this;
        res
    }

    fn take_from_right_given_bits(&mut self, bits_of_right_max_value: usize) -> u64 {
        let (this, res) = stash_in_bit_const::take_from_right_given_bits(*self, bits_of_right_max_value);
        *self = this;
        res
    }
    
    fn read_given_bits(&self, bits_of_max_value: usize, shift_from_right: usize) -> u64 {
        stash_in_bit_const::read_given_bits(*self, bits_of_max_value, shift_from_right)
    }

    fn read_given_bitwise_max_value(&self, bitwise_max_value: u64, shift_from_right: usize) -> u64 {
        stash_in_bit_const::read_given_bitwise_max_value(*self, bitwise_max_value, shift_from_right)
    }
}

pub mod stash_in_bit_const {
