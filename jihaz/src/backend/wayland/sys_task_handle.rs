...
impl SystemTaskHandle {
    pub fn new() -> Result<Self, Error> {
            ...
            move |event: &'_ wl::GlobalEvent,
                ...
                match event {
                    wl::GlobalEvent::New {
                        ...
                        // finished constructing the `SystemTaskHandle`. That way we can pass it as a
                        // parameter.
                    }
        ...
        Ok(SystemTaskHandle { data: appdata })
    }
...
impl From<SystemTaskHandle> for surfaces::CompositorHandle {
    fn from(app: SystemTaskHandle) -> surfaces::CompositorHandle {
