        ...
        T: serde::de::DeserializeOwned,
    {
        ...
        // if attempt_other_incoding {
            if let Err(e) = &res {
                ...
                // <*> failed deserializing Json, trying Bincode. error is serde_json error: missing field `panes` at line 1 column 19085. path: "/Users/abdallah/Library/Application Support/Quest/sync/files/coding.quest"
